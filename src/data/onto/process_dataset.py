...
def write_array_to_flair_file(documents, file_path, separator=' ', word_ending='\n'):
    with open(file_path, 'w+') as out:
        for document in documents:
            for sentence in document:
                for (word, tag) in zip(sentence['words'], sentence['tags']):
...
def process_data_for_spacy(X_cased, X_uncased):
    ...
    write_array_to_conll_file(X_train_cased, cased_train_path, separator='\t', word_ending='\n')
    write_array_to_conll_file(X_test_cased, cased_test_path, separator='\t', word_ending='\n')
    write_array_to_conll_file(X_dev_cased, cased_dev_path, separator='\t', word_ending='\n')

    write_array_to_conll_file(X_train_uncased, uncased_train_path, separator='\t', word_ending='\n')
    write_array_to_conll_file(X_test_uncased, uncased_test_path, separator='\t', word_ending='\n')
    write_array_to_conll_file(X_dev_uncased, uncased_dev_path, separator='\t', word_ending='\n')
...
def process_data_for_flair(X_cased, X_uncased):
    ...
    write_array_to_flair_file(X_train_cased, cased_train_path, separator=' ', word_ending='\n')
    write_array_to_flair_file(X_test_cased, cased_test_path, separator=' ', word_ending='\n')
    write_array_to_flair_file(X_dev_cased, cased_dev_path, separator=' ', word_ending='\n')

    write_array_to_flair_file(X_train_uncased, uncased_train_path, separator=' ', word_ending='\n')
    write_array_to_flair_file(X_test_uncased, uncased_test_path, separator=' ', word_ending='\n')
    write_array_to_flair_file(X_dev_uncased, uncased_dev_path, separator=' ', word_ending='\n')
